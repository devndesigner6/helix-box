...
export const EnterpriseTrustSection = () => {
  return (
    <section className="py-24 px-6 max-w-7xl mx-auto border-t border-[#c3c2b2]/60">
      
      <div className="text-center max-w-3xl mx-auto mb-16">
        <span className="font-mono text-xs font-bold text-[#0b4fff] tracking-widest uppercase">ENTERPRISE SECURITY</span>
        <h2 className="text-4xl sm:text-5xl font-cabinet font-black text-[#232323] mt-2 mb-4">
          Built for enterprise trust
        </h2>
        <p className="text-[#555555] text-base leading-relaxed">
          Zero-trust security architecture ensuring your workstation credentials and code stay 100% private.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="auxia-card p-8 flex flex-col justify-between">
          <div>
            ...
            <h3 className="font-cabinet font-bold text-xl text-[#232323] mb-2">TLS 1.3 Encryption</h3>
          ...
          <ul className="space-y-2 text-xs text-[#555555] border-t border-[#c3c2b2]/60 pt-4">
            ...
            <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Zero Plaintext Log Storage</li>
          </ul>
        </div>
        ...
        <div className="auxia-card p-8 flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs text-[#555555] leading-relaxed mb-6">
              Uses outbound WebSocket connections via proxy relays. You never need to open incoming router ports or expose SSH daemons to the internet.
            </p>
          </div>
          <ul className="space-y-2 text-xs text-[#555555] border-t border-[#c3c2b2]/60 pt-4">
        ...
        <div className="auxia-card p-8 flex flex-col justify-between">
          <div>
            ...
            <h3 className="font-cabinet font-bold text-xl text-[#232323] mb-2">100% Open Source (MIT)</h3>
            <p className="text-xs text-[#555555] leading-relaxed mb-6">
